...
public class TwoSplitterBlockScreenHandler extends ScreenHandler {
    ...
    private final TwoSplitterConveyorBlockEntity entity;
    ...
    public TwoSplitterBlockScreenHandler(final int syncId) {
    ...
    public TwoSplitterBlockScreenHandler(final TwoSplitterConveyorBlockEntity entity, final int syncId) {
        super(TLMScreenHandlerTypes.TWO_SPLITTER_BLOCK_SCREEN_HANDLER_TYPE, syncId);
        this.entity = entity;
        propertyMap = new EnumMap<>(ConveyorTrayDataStack.State.class);
        final TwoSplitterConveyorBlockEntity.Choice[] choices = TwoSplitterConveyorBlockEntity.Choice.values();
        for (final ConveyorTrayDataStack.State state : ConveyorTrayDataStack.State.values()) {
    ...
    public TwoSplitterConveyorBlockEntity.Choice getChoice(@Nullable final ConveyorTrayDataStack.State state) {
        final TwoSplitterConveyorBlockEntity.Choice[] choices = TwoSplitterConveyorBlockEntity.Choice.values();
        if (state == null) {
