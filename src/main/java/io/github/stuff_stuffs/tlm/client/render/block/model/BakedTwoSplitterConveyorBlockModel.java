...
public class BakedTwoSplitterConveyorBlockModel implements BakedModel, FabricBakedModel {
    private final Sprite sprite;
    private final ConveyorRenderer renderer;

    public BakedTwoSplitterConveyorBlockModel(final Sprite sprite, final Sprite clockWiseSprite, final Sprite counterClockWiseSprite) {
        this.sprite = sprite;
