...
public class ThreeSplitterBlockHandledScreen extends HandledScreen<ThreeSplitterBlockScreenHandler> {
    private final PlayerEntity entity;
    private ButtonWidget redChoiceButton, greenChoiceButton, blueChoiceButton, yellowChoiceButton;

    public ThreeSplitterBlockHandledScreen(final ThreeSplitterBlockScreenHandler handler, final PlayerInventory inventory, final Text title) {
