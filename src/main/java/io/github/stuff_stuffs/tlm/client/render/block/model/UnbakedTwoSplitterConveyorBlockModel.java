...
public class UnbakedTwoSplitterConveyorBlockModel implements UnbakedModel {
    public static final SpriteIdentifier SPRITE = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, TLM.createId("block/two_split_conveyor_belt"));
    @Override
    ...
    public BakedModel bake(final ModelLoader loader, final Function<SpriteIdentifier, Sprite> textureGetter, final ModelBakeSettings rotationContainer, final Identifier modelId) {
        return new BakedTwoSplitterConveyorBlockModel(textureGetter.apply(SPRITE), textureGetter.apply(UnbakedConveyorBlockModel.CLOCKWISE_SPRITE), textureGetter.apply(UnbakedConveyorBlockModel.COUNTER_CLOCKWISE_SPRITE));
    }
}
