...
public class BakedLabelerBlockModel implements BakedModel, FabricBakedModel {
    private final Sprite sprite;
    private final ConveyorRenderer renderer;

    public BakedLabelerBlockModel(final Sprite sprite, final Sprite clockWiseSprite, final Sprite counterClockWiseSprite) {
        this.sprite = sprite;
